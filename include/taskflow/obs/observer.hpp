...
class observer {
 public:
  ...
  virtual void on_compensation_start(std::size_t /*exec_id*/, std::size_t /*node_id*/,
                                    std::string_view /*compensate_task_type*/, std::int32_t /*attempt*/) noexcept {}

  virtual void on_compensation_complete(std::size_t /*exec_id*/, std::size_t /*node_id*/,
                                        std::string_view /*compensate_task_type*/,
                                        std::chrono::milliseconds /*duration_ms*/) noexcept {}

  virtual void on_compensation_fail(std::size_t /*exec_id*/, std::size_t /*node_id*/,
